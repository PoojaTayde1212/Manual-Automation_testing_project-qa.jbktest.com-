...
public class MyAccount__TotalTopicsCovered {
public static void main(String[] args) {
	    ...
	    driver.findElement(By.xpath("/html/body/div/div/div[2]/div[1]/div[2]/div[5]/div/div/div/div[1]/div/a")).click();  //for viewing the total attempt
